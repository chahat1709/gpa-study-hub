...
const pastPapersList = [
  { id: '1', title: 'DBMS GTU End-Sem Paper', year: 'Winter 2024', subject: 'DBMS', code: '3140705' },
  { id: '2', title: 'Cyber Security GTU End-Sem', year: 'Summer 2024', subject: 'CYBER SEC', code: '3140706' },
  { id: '3', title: 'Advance Python Programming GTU', year: 'Winter 2023', subject: 'AD PYTHON', code: '3140707' },
  { id: '4', title: 'Embedded Systems GTU End-Sem', year: 'Summer 2023', subject: 'ES', code: '3140708' }
];
    ...
    <div role="tabpanel" className="flex flex-col gap-6 animate-fade-in">
      <div className="glass-card p-6 rounded-3xl border border-white/10 text-white shadow-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-xs text-slate-300 mt-0.5">Access official GTU examination papers with instant step-by-step AI solution keys.</p>
        </div>
        <div className="flex items-center gap-2">
          <label className="text-xs font-bold text-slate-300">Filter Year:</label>
          <select value={paperYear} onChange={e => setPaperYear(e.target.value)}
            className="p-2.5 bg-white/5 border border-white/10 rounded-xl text-xs font-bold text-white outline-none">
            <option value="Winter 2024" className="bg-slate-900 text-white">Winter 2024</option>
            <option value="Summer 2024" className="bg-slate-900 text-white">Summer 2024</option>
            <option value="Winter 2023" className="bg-slate-900 text-white">Winter 2023</option>
            <option value="Summer 2023" className="bg-slate-900 text-white">Summer 2023</option>
          </select>
        </div>
      </div>
