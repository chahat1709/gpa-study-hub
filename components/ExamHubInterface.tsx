...
const ExamHubInterface: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col overflow-y-auto no-scrollbar pb-24 lg:pb-8" style={{ background: 'transparent' }}>
      {/* Top Banner */}
      <div className="bg-[rgba(15,23,42,0.8)] backdrop-blur-[30px] text-white p-6 lg:p-8 shrink-0 relative overflow-hidden shadow-[0_4px_30px_rgba(0,0,0,0.1)] border-b border-white/10">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative z-10">
          ...
          <div className="glass-card bg-[rgba(15,23,42,0.8)] backdrop-blur-[30px] border border-white/20 p-5 rounded-[24px] flex items-center gap-4 shrink-0 min-w-[260px] shadow-[0_0_20px_rgba(67,56,202,0.15)] transform hover:scale-[1.02] hover:shadow-[0_0_25px_rgba(67,56,202,0.25)] transition-all duration-300">
      ...
      <div className="max-w-6xl w-full mx-auto p-4 lg:p-8 flex-1 flex flex-col gap-6 relative z-10">
        {/* Navigation Tabs */}
        <div className="flex p-1.5 rounded-2xl gap-1 overflow-x-auto no-scrollbar glass-card bg-white/5 backdrop-blur-[30px] border border-white/10 shadow-[0_0_15px_rgba(47,217,244,0.05)]" role="tablist">
          {([
