  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        />
        <div
          className="absolute -bottom-40 -right-40 w-[500px] h-[500px] rounded-full opacity-[0.10] blur-3xl"
        ...
        <div className="glass-card p-8 rounded-3xl border border-white/10 text-center">
          <div
            ...
            style={{
              ...
              boxShadow: '0 0 32px rgba(0,242,254,0.3)',
            }}
          >
          ...
          <div className="space-y-3">
            ...
            <p className="text-[10px] text-slate-500">
              Find your PC's IP: Open CMD → type{' '}
              <span className="font-mono text-cyan-400">ipconfig</span>
            </p>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-left">
                ...
                <ol className="text-[10px] text-slate-400 space-y-0.5 list-decimal list-inside">
                  <li>
                    Run <span className="font-mono text-cyan-400">npm start</span> in the server
                    folder
                  </li>
