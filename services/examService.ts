...
export const examService = {
  ...
  evaluateWrittenAnswer: async (
    ...
    try {
      ...
      if (isImage) {
        ...
        contents = {
          parts: [{ inlineData: { mimeType, data: base64Data } }, { text: rubricPrompt }],
        };
      } else {
      ...
      const conceptClarity = Math.min(
        40,
        Math.max(0, Math.round(Number(rawBreakdown.conceptClarity) || 0))
      );
      const technicalAccuracy = Math.min(
        30,
        Math.max(0, Math.round(Number(rawBreakdown.technicalAccuracy) || 0))
      );
      const overallScore = Math.min(
        100,
        Math.max(0, keywords + conceptClarity + technicalAccuracy)
      );
  ...
  getStudentStats: async (studentId: string) => {
      ...
      try {
        ...
        results = snap.docs.map(doc => {
          ...
          return {
            ...
            date: d.date,
            timestamp:
              d.timestamp instanceof Timestamp ? d.timestamp.toDate().toISOString() : d.timestamp,
          };
        });
      } catch {
        const saved = localStorage.getItem(STORAGE_KEY_RESULTS);
    ...
    const readinessIndex = Math.min(
      99,
      Math.round(avgPercentage * 0.9 + Math.min(10, totalExams * 2))
    );
  ...
  getClassReadinessOverview: (results: ExamResult[]) => {
    ...
    const readinessStatus =
      classReadinessIndex >= 80
        ? 'EXAM READY 🚀'
        : classReadinessIndex >= 65
      ...
      ? [
          {
            ...
            correctAnswer: 1,
            explanation:
              'A capacitor stores electric charge and energy in an electric field between its plates.',
          },
          {
            id: 'q2',
            ...
            correctAnswer: 2,
            explanation:
              "Resistance is measured in Ohms (Ω), named after Georg Simon Ohm who stated Ohm's Law: V = IR.",
          },
          {
            id: 'q3',
            ...
            options: [
              ...
              'Both terminals at same potential',
              'Reverse voltage applied',
            ],
            correctAnswer: 1,
            explanation:
              'Forward bias connects the positive terminal to the P-side and negative to the N-side, allowing current to flow.',
          },
          {
            id: 'q4',
            question: 'The truth table of AND gate: A=1, B=0 gives output:',
            options: ['1', '0', 'Undefined', 'Both 0 and 1'],
            correctAnswer: 1,
            explanation: 'AND gate output is 1 only when ALL inputs are 1. Since B=0, output is 0.',
          },
          {
            id: 'q5',
            question: 'Which flip-flop is known as a "divide-by-2" circuit?',
            options: ['SR Flip-flop', 'D Flip-flop', 'JK Flip-flop', 'T Flip-flop'],
            correctAnswer: 3,
            explanation:
              'T (Toggle) flip-flop changes state on every clock pulse, dividing the clock frequency by 2.',
          },
        ]
      : [
          {
            ...
            correctAnswer: 2,
            explanation:
              'HTTPS (HTTP Secure) uses SSL/TLS encryption to secure data between browser and server.',
          },
          {
            id: 'q2',
            ...
            correctAnswer: 0,
            explanation:
              'CPU — Central Processing Unit — is the brain of a computer, executing instructions.',
          },
          {
            id: 'q3',
            ...
            correctAnswer: 2,
            explanation: 'The <a> anchor tag with href attribute creates hyperlinks in HTML.',
          },
          {
            id: 'q4',
            question: 'Which CSS property controls text size?',
            options: ['text-weight', 'font-size', 'text-style', 'font-weight'],
            correctAnswer: 1,
            explanation: 'font-size property sets the size of the text, e.g., font-size: 16px.',
          },
          {
            id: 'q5',
            question: 'A computer network that covers a small area (single building) is called:',
            options: ['WAN', 'MAN', 'LAN', 'PAN'],
            correctAnswer: 2,
            explanation:
              'LAN (Local Area Network) covers a limited area like a building or campus.',
          },
        ];
    return {
    ...
    const defaultQuizzes: Quiz[] = [
        ...
        questions: [
          {
            ...
            options: ['Resistance', 'Voltage', 'Power', 'Frequency'],
            correctAnswer: 1,
            explanation:
              "Ohm's Law: I = V/R. Current (I) is directly proportional to Voltage (V) at constant resistance.",
          },
          {
            id: 'be2',
            question: 'Which material has the lowest resistivity?',
            options: ['Silicon', 'Germanium', 'Copper', 'Carbon'],
            correctAnswer: 2,
            explanation:
              'Copper has resistivity of ~1.7×10⁻⁸ Ω·m, making it the best conductor among these.',
          },
          {
            id: 'be3',
            question: 'A transistor in saturation region acts as:',
            options: ['Open switch', 'Amplifier', 'Closed switch', 'Oscillator'],
            correctAnswer: 2,
            explanation:
              'In saturation, both junctions are forward biased and transistor acts like a closed switch (ON state).',
          },
          {
            id: 'be4',
            ...
            correctAnswer: 1,
            explanation:
              'Silicon diode has a forward voltage drop (knee voltage) of approximately 0.7V.',
          },
          {
            id: 'be5',
            question: 'Zener diode is used primarily as:',
            options: ['Rectifier', 'Amplifier', 'Voltage regulator', 'Oscillator'],
            correctAnswer: 2,
            explanation:
              'Zener diode operates in reverse breakdown region to maintain a constant output voltage — used as a voltage regulator.',
          },
          {
            id: 'be6',
            ...
            options: [
              ...
              'Bipolar JFET Terminal',
              'Base Junction Terminal',
            ],
            correctAnswer: 0,
            explanation:
              'BJT = Bipolar Junction Transistor — has two P-N junctions and uses both holes and electrons as carriers.',
          },
          {
            id: 'be7',
            question: 'Which configuration gives highest voltage gain in BJT?',
            options: ['Common Base', 'Common Emitter', 'Common Collector', 'None'],
            correctAnswer: 1,
            explanation:
              'Common Emitter (CE) configuration provides highest voltage gain (~hundreds) among the three BJT configurations.',
          },
          {
            id: 'be8',
            question: 'The color code for a 470Ω resistor (4-band) is:',
            options: [
            ...
            correctAnswer: 0,
            explanation: '4=Yellow, 7=Violet, ×10=Brown, ±5%=Gold → 470Ω ±5%.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            id: 'na1',
            question: 'KCL states that sum of currents at a node is:',
            options: ['Equal to voltage', 'Zero', 'Equal to resistance', 'Maximum'],
            correctAnswer: 1,
            explanation:
              "Kirchhoff's Current Law (KCL): Sum of all currents entering a node = Sum of all currents leaving. Net = 0.",
          },
          {
            id: 'na2',
            question: 'In series RLC circuit at resonance, impedance is:',
            options: ['Maximum', 'Minimum', 'Zero', 'Infinite'],
            correctAnswer: 1,
            explanation:
              'At resonance, XL = XC, so they cancel. Impedance Z = R (minimum), current is maximum.',
          },
          {
            id: 'na3',
            question: "Thevenin's theorem replaces a network with:",
            options: [
              'Current source + parallel R',
            ...
            correctAnswer: 1,
            explanation:
              'Thevenin equivalent = Vth (open circuit voltage) in series with Rth (Thevenin resistance).',
          },
          {
            id: 'na4',
            ...
            correctAnswer: 1,
            explanation:
              'Time constant τ = RC (seconds). It represents time for capacitor to charge to 63.2% of supply voltage.',
          },
          {
            id: 'na5',
            ...
            correctAnswer: 2,
            explanation:
              'Purely resistive circuit has voltage and current in phase, so cos(0°) = 1. Power factor = 1.',
          },
          {
            id: 'na6',
            question: "Norton's theorem replaces a network with:",
            options: [
              'Voltage source + series R',
              'Current source + parallel R',
              'Thevenin source',
            ...
            correctAnswer: 1,
            explanation:
              'Norton equivalent = IN (short circuit current) in parallel with RN (Norton resistance = Rth).',
          },
          {
            id: 'na7',
            question: 'Superposition theorem is applicable for:',
            options: [
              'Non-linear circuits only',
              'Linear circuits only',
              'Any circuit',
              'Circuits with no source',
            ],
            correctAnswer: 1,
            explanation:
              'Superposition applies only to linear circuits — response due to each source is added algebraically.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            ...
            options: ['AND, OR', 'NOT, AND', 'NAND, NOR', 'XOR, XNOR'],
            correctAnswer: 2,
            explanation:
          ...
          {
            id: 'de2',
            question: 'Binary number 1010 in decimal is:',
            options: ['8', '10', '12', '14'],
            correctAnswer: 1,
          ...
          {
            id: 'de3',
            question: "2's complement of 0110 is:",
            options: ['1001', '1010', '1110', '0110'],
            correctAnswer: 1,
          ...
          },
          {
            ...
            correctAnswer: 1,
            explanation:
              'Full adder has 3 inputs: A, B, and Carry-in (Cin). Outputs: Sum and Carry-out.',
          },
          {
            id: 'de5',
            ...
            correctAnswer: 1,
            explanation:
              'Karnaugh Map (K-map) provides systematic method for minimizing Boolean expressions to reduce gate count.',
          },
          {
            id: 'de6',
            question: 'Hexadecimal F is equivalent to decimal:',
            options: ['14', '15', '16', '13'],
            correctAnswer: 1,
            explanation:
              'Hexadecimal digits: 0-9 same as decimal, A=10, B=11, C=12, D=13, E=14, F=15.',
          },
          {
            id: 'de7',
            question: 'JK flip-flop with J=1, K=1 input gives:',
            options: ['Set', 'Reset', 'No change', 'Toggle'],
            correctAnswer: 3,
            explanation:
              'JK flip-flop: J=0,K=0→No change; J=1,K=0→Set; J=0,K=1→Reset; J=1,K=1→Toggle (complement).',
          },
        ],
      },
      ...
      // ── ICTET BRANCH ──────────────────────────────────────────────────
      {
        ...
        questions: [
          ...
          {
            id: 'cn2',
            question: 'IP address class A range is:',
            options: ['128-191', '192-223', '1-126', '224-247'],
            correctAnswer: 2,
            explanation:
              'Class A: 1.0.0.0 to 126.0.0.0. First bit = 0. Supports 16M+ hosts per network.',
          },
          {
            id: 'cn3',
            question: 'TCP is a ________ protocol:',
            options: ['Connectionless', 'Unreliable', 'Connection-oriented', 'Stateless'],
            correctAnswer: 2,
            explanation:
              'TCP (Transmission Control Protocol) is connection-oriented — establishes a 3-way handshake before data transfer.',
          },
          {
            id: 'cn4',
            question: 'DNS converts:',
            options: ['IP to MAC', 'Domain name to IP', 'IP to physical address', 'Email to IP'],
            correctAnswer: 1,
            explanation:
              'DNS (Domain Name System) resolves human-readable domain names (google.com) to IP addresses (142.250.x.x).',
          },
          {
            id: 'cn5',
            question: 'Which device operates at Network layer (Layer 3)?',
            options: ['Switch', 'Hub', 'Router', 'Repeater'],
            correctAnswer: 2,
            explanation:
              'Router operates at Layer 3 (Network). It routes packets between different networks using IP addresses.',
          },
          {
            id: 'cn6',
            question: 'Default subnet mask for Class C is:',
            options: ['255.0.0.0', '255.255.0.0', '255.255.255.0', '255.255.255.255'],
            correctAnswer: 2,
            explanation:
              'Class C default subnet mask = 255.255.255.0 (/24). Supports 254 usable hosts per network.',
          },
          {
            id: 'cn7',
            ...
            correctAnswer: 2,
            explanation: 'HTTP uses port 80. HTTPS uses port 443. FTP uses 21. Telnet uses 23.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            ...
            correctAnswer: 2,
            explanation:
              '<h1> defines the largest/most important heading. <h6> is the smallest. There are 6 heading levels.',
          },
          {
            id: 'wt2',
            question: 'CSS selector for class "box" is:',
            options: ['#box', '.box', 'box', '*box'],
            correctAnswer: 1,
            explanation:
              '.box selects all elements with class="box". # is for ID, no prefix for element, * is universal.',
          },
          {
            id: 'wt3',
            question: 'JavaScript is a ________ language:',
            options: ['Compiled', 'Machine', 'Interpreted', 'Assembly'],
            correctAnswer: 2,
            explanation:
              "JavaScript is an interpreted (scripting) language — executed line by line by browser's JS engine.",
          },
          {
            id: 'wt4',
            question: 'Which HTML5 element plays video?',
            options: ['<media>', '<video>', '<movie>', '<film>'],
            correctAnswer: 1,
            explanation:
              'HTML5 <video> element: <video src="file.mp4" controls></video> — no Flash needed.',
          },
          {
            id: 'wt5',
            ...
            options: [
              ...
              'Programmable HTML Page',
            ],
            correctAnswer: 2,
            explanation:
              'PHP originally stood for "Personal Home Page" but now officially means "PHP: Hypertext Preprocessor" (recursive).',
          },
          {
            id: 'wt6',
            question: 'CSS box model layers (outside to inside):',
            options: [
            ...
            correctAnswer: 1,
            explanation: 'CSS Box Model (outer to inner): Margin → Border → Padding → Content.',
          },
          {
            id: 'wt7',
            question: 'SQL SELECT statement syntax:',
            options: [
            ...
            correctAnswer: 1,
            explanation:
              'Basic SQL: SELECT columns FROM tablename WHERE condition; Example: SELECT * FROM students;',
          },
        ],
      },
      {
        ...
        questions: [
          {
            ...
            correctAnswer: 2,
            explanation:
              '<stdio.h> (Standard Input Output) provides printf(), scanf(), and file I/O functions.',
          },
          {
            id: 'cp2',
            question: 'Size of int data type in C (32-bit system):',
            options: ['1 byte', '2 bytes', '4 bytes', '8 bytes'],
            correctAnswer: 2,
            explanation:
              'int is 4 bytes (32 bits) on most modern 32-bit and 64-bit systems. Range: -2³¹ to 2³¹-1.',
          },
          {
            id: 'cp3',
            ...
            correctAnswer: 2,
            explanation:
              'do-while loop checks condition AFTER executing body — guaranteed to run at least once even if condition is false.',
          },
          {
            id: 'cp4',
            question: 'Correct way to declare array of 5 integers:',
            options: ['int a{5}', 'array int a[5]', 'int a[5]', 'int[5] a'],
            correctAnswer: 2,
            explanation:
              'int a[5]; declares array of 5 integers: a[0] to a[4]. Index starts from 0 in C.',
          },
          {
            id: 'cp5',
            question: '& operator in C is used for:',
            options: ['Multiplication', 'Bitwise AND / Address-of', 'Logical OR', 'Division'],
            correctAnswer: 1,
            explanation:
              '& is used for: (1) Bitwise AND between two integers, (2) Address-of operator to get memory address of a variable.',
          },
          {
            id: 'cp6',
            question: 'What does return 0; at end of main() mean?',
            options: ['Error occurred', 'Program ran successfully', 'Restart program', 'Nothing'],
            correctAnswer: 1,
            explanation:
              'return 0 from main() signals the OS that the program terminated successfully (exit code 0 = success).',
          },
          {
            id: 'cp7',
            question: 'strcpy() function is used to:',
            options: [
              'Compare strings',
            ...
            correctAnswer: 1,
            explanation:
              'strcpy(dest, src) copies string from src to dest. strcat() concatenates, strlen() gives length, strcmp() compares.',
          },
        ],
      },
    ];
